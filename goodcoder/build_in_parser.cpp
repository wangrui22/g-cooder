...
int parse(const char *str, int *res) { return parse(str, res, "%d"); }

int parse(const char *str, uint32_t *res) { return parse(str, res, "%u"); }

int parse(const char *str, float *res) { return parse(str, res, "%f"); }

int parse(const char *str, double *res) { return parse(str, res, "%lf"); }

int parse(const char *str, uint64_t *res) { return parse(str, res, "%llu"); }
